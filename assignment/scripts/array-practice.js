...
let foodArray = ['popcorn', 'chicken', 'sushi', 'burgers'];
...
console.log('number of favorite food', foodArray.length);
...
foodArray.push('banana')
console.log('Added another food,', foodArray);
...
console.log('the array of food is,', foodArray);
...
foodArray.unshift('banana bread');
